import { c as useState, b as useRuntimeConfig, _ as __nuxt_component_0 } from './server.mjs';
import { defineComponent, useSlots, toRefs, computed, h, useSSRContext } from 'vue';
import { h as hash } from '../_/index.mjs';
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-C6-TsK-y.mjs';
import { u as useContentPreview } from './preview-C-taXg7G.mjs';
import '../_/nitro.mjs';
import 'unified';
import 'remark-parse';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DbZrfuaj.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BjM34eS5.mjs.map
