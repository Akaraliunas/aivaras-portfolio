...
import { w as withLeadingSlash, l as joinURL, v as withoutTrailingSlash, M as withBase } from '../_/nitro.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DbZrfuaj.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-C6-TsK-y.mjs.map
